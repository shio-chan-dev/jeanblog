...
Run this checklist before delivering an algorithm-problem ACERS post.

- Front matter contains `title`, `date`, `draft`, `categories`, `tags`,
...
- No theme, config, workflow, or generated-output files were changed.
